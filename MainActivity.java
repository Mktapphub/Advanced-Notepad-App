...
private Intent plan = new Intent();
...
@Override
public void onClick(View _view) {
plan.setAction(Intent.ACTION_VIEW);
plan.setClass(getApplicationContext(), DailyPlannerActivity.class);
startActivity(plan);
}
});
...
int[] colors = {Color.parseColor(App_Theme), Color.parseColor("#FF009688")};
...
important_length.setText(c.getString("count", ""));
}
...
_UIDESIGN();
_Add("#FF009688", ic_settings);
empty_txt.setTextColor(0xFF009688);
}
else {
...
empty_txt.setTextColor(0xFFFFFFFF);
...
Window w = MainActivity.this.getWindow();w.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);w.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS); w.setStatusBarColor(Color.parseColor("#FFFFFF")); main.setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
main.setBackgroundColor(0xFFFFFFFF);
welcome_title.setTextColor(0xFFE91E63);
_Add("#E91E63", ic_settings);
_Add("#E91E63", empty_img);
empty_txt.setTextColor(0xFFE91E63);
recent_title.setTextColor(0xFFE91E63);
important_len_title.setTextColor(0xFFE91E63);
important_length.setTextColor(0xFFE91E63);
title.setTextColor(0xFFE91E63);
int[] colors = {Color.parseColor("#E91E63"), Color.parseColor("#880E4F")};
...
.setShortLabel("Recent")
.setLongLabel("Recent Note")
.setRank(2)
.setIntent(new android.content.Intent(android.content.Intent.ACTION_VIEW, null, MainActivity.this, MainActivity.class))
.setIcon(android.graphics.drawable.Icon.createWithResource(MainActivity.this, R.drawable.notes))
.build();
